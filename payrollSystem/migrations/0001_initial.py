# Generated by Django 3.2.13 on 2022-04-30 20:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('occupation', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='payrollSystem.occupation', verbose_name='Απασχόληση')),
            ],
        ),
        migrations.CreateModel(
            name='PersonSchedule',
            fields=[
                ...
                ('person', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='schedules', to='payrollSystem.person')),
            ],
            options={
                'ordering': ['-date_start'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('person', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='person_invoices', to='payrollSystem.person')),
            ],
            options={
